...
Dim wtArgs
wtArgs = "-w new nt --title ""System-Tools-PATH-Admin"" pwsh.exe -NoExit -ExecutionPolicy Bypass -File """ & scriptPath & """ -Action Menu -TargetPath """ & targetPath & """ -SkipWtBootstrap -NoPause"
