...
Dim wtArgs
wtArgs = "-w 0 nt --title ""System-Tools-PATH-Admin"" pwsh.exe -NoExit -ExecutionPolicy Bypass -File """ & scriptPath & """ -Action Menu -TargetPath """ & targetPath & """ -SkipWtBootstrap -NoPause"
